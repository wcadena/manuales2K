...
$query_Recordset1 = sprintf("SELECT * FROM perfiles_usuario_".$sitio_manuales7sd." as u, perfiles_".$sitio_manuales7sd." as p WHERE u.id_perfiles = p.id and  id_users = %s", 
	GetSQLValueString($colname_rs_user, "int"));
